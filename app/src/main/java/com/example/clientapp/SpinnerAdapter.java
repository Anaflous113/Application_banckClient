...
public class SpinnerAdapter extends ArrayAdapter<Beneficière> {
    private ArrayList<Beneficière> myarrayList;
    TextView label,label2;
    Beneficière myModel;
    String name;

    public SpinnerAdapter(Context context, int textViewResourceId, ArrayList<Beneficière> modelArrayList) {
        super(context, textViewResourceId, modelArrayList);
        this.myarrayList = modelArrayList;
    }

    public SpinnerAdapter(Context context, int textViewResourceId, Beneficière model) {
    ...
    @Nullable
    @Override
    public Beneficière getItem(int position) {
    ...
    private View getCustomView(int position, ViewGroup parent) {
        Beneficière model = getItem(position);
